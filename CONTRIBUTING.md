# Contributing to oxidized-lighting
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/lighting.git
cd lighting
...
`oxidized-lighting` is a library crate in the
...
Use `lighting` as the scope for all changes to this crate.
